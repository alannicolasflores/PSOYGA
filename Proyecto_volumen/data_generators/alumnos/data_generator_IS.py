...
temas = cargar_temas("temas_IS.json")  # Cargar los temas desde el archivo JSON



# Ruta donde se encuentran los archivos de alumnos
alumnos_path = "../../final_data/alumnos_IS" 
# Ruta donde se encuentran los archivos de unidad
unidad_path = "../../final_data/unidad_IS"  
# Ruta donde se generarán los archivos combinados
ruta_salida = "../../final_data/entrada_final_IS"  
